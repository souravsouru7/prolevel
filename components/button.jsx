...
const AnimatedLayerButton = React.forwardRef(({ className, children, ...props }, ref) => {
  return (
    <button
      className={cn(
        // Base styles for the button
        "group relative flex h-[50px] w-[180px] items-center justify-center overflow-hidden rounded-[30px] border border-white/30",
        "cursor-pointer bg-white/90 backdrop-blur-xl transition-all duration-300 ease-in-out",
        "hover:border-pink-400/50 hover:bg-black hover:scale-105",
      ...
      ref={ref}
      {...props}>
      {/* SVG layer for the background animation */}
      <svg
        className={cn(
        ...
        aria-hidden="true">
        <path
          className="transition-all duration-300 fill-white/80 group-hover:fill-black"
        ...
        <path
          className="transition-all duration-300 fill-white/70 group-hover:fill-black"
          ...
          transform="translate(-202.29 -201.89)" />
        <path
          className="transition-all duration-300 fill-white/60 group-hover:fill-black"
          ...
          transform="translate(-202.29 -201.89)" />
        <path
          className="transition-all duration-300 fill-white/50 group-hover:fill-black"
          ...
          transform="translate(-202.29 -201.89)" />
        <path
          className="transition-all duration-300 fill-white/40 group-hover:fill-black"
          ...
          transform="translate(-202.29 -201.89)" />
        <path
          className="transition-all duration-300 fill-black group-hover:fill-black"
      ...
      {/* Text layer */}
      <span className="z-10 font-semibold text-black group-hover:text-white transition-all duration-300 text-[1.1em]">
        {children}
      </span>
    </button>
  );
