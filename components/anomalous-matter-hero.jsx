...
export function AnomalousMatterHero({
  ...
  return (
    <section
      ...
      <div
        className="absolute inset-0 bg-gradient-to-t from-[hsl(var(--background))] via-[hsl(var(--background))/70] to-transparent z-10" />
      <div
        className="relative z-20 flex flex-col items-center justify-end h-full pb-20 md:pb-32 text-center">
        <div className="max-w-3xl px-4 animate-fade-in-long">
          <h1
            className="text-sm font-mono tracking-widest text-[hsl(var(--sky-300)/80)] uppercase">
            {title}
          </h1>
          ...
          <p
            className="mt-6 max-w-xl mx-auto text-base leading-relaxed text-[hsl(var(--gray-300)/80)]">
            {description}
          </p>
        </div>
      </div>
